...
export const semantics: Readonly<Array<H5PField | H5PBehaviour | H5PL10n>> = [
  {
    ...
    fields: [
      ...
      {
        label: "Footer OsloMet label",
        name: "footerOsloMetLabel",
        default: "OsloMet - Oslo Metropolitan University",
        type: "text",
      },
      {
        label: "Footer OsloMet URL",
        name: "footerOsloMetHref",
        default: "https://oslomet.no/",
        type: "text",
      },
      {
        label: "Footer Lexin label",
        name: "footerLexinLabel",
        default: "LEXIN",
        type: "text",
      },
      {
        label: "Footer Lexin URL",
        name: "footerLexinHref",
